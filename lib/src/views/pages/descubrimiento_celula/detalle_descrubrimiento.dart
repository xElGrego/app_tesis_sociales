...
class DetalleDescrubrimiento extends StatelessWidget {
  final DescubrimientoCelula detalleDescrubrimiento;
  // ignore: use_key_in_widget_constructors
  const DetalleDescrubrimiento(this.detalleDescrubrimiento);
