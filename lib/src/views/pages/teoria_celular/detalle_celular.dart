...
class TeoriaCelularDetalle extends StatelessWidget {
  final TeoriaCelular teoriaCelularDetalle;
  // ignore: use_key_in_widget_constructors
  const TeoriaCelularDetalle(this.teoriaCelularDetalle);
