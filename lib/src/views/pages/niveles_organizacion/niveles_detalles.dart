...
import 'data_organizacion.dart';

class DetalleNiveles extends StatelessWidget {
  final NivelesOrganizacion detalleNiveles;
  // ignore: use_key_in_widget_constructors
  const DetalleNiveles(this.detalleNiveles);
